...
\usepackage{wrapfig}
\usepackage{mathtools, nccmath}     % For \vcentcolon and smaller math fonts
...
\hyphenation{sub-mo-du-lar}
\hyphenation{su-per-mo-du-lar}
\hyphenation{Sub-mo-du-la-re}
...
\appendix
\input{chapters/appendix_exp.tex}

\chapter{Sampling with Semigradients} \label{ch:m3}
...
\end{cor}
From \theoremref{thm:spectral} it follows that the mixing time of Gibbs is $\tme = \Omega\left((e^{cn} - 1)\log(1/(2\epsilon)) \right)$.
...
\setlength\figurewidth{0.38\textwidth}
\renewcommand{\subflen}{0.33\textwidth}
\renewcommand{\scspacey}{-1.8em}
...
\renewcommand{\subflen}{0.45\textwidth}

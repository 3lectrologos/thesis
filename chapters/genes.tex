...
\end{align*}
The gradient of the log-likelihood with respect to the parameters $\btheta$ is (cf. \citealp{wainwright08})
\begin{align*}
...
As a reminder, the \fldc{} model is in that case defined via the following function (cf. \exampleref{ex:flcd}),
\begin{align*}

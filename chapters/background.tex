...
The visited states $(X_0, X_1,\ldots)$ form a Markov chain, which under mild conditions (e.g., Theorem 4.9, \citealp{levin08book}) converges to a stationary distribution $p$.
...
\end{align*}
A generalization of Chebyshev's inequality to correlated Markov chain samples (see Theorem 12.19, \citealp{levin08book}) shows that upper bounding the mixing time is sufficient to guarantee efficient approximate sampling-based inference.